...
<head>
<link href="tax.css" rel="alternate stylesheet" type="text/css" title="normal" media="screen">
<link href="taxi.css" rel="stylesheet" type="text/css" title="iphone" media="screen">
...
function CheckRev()
{
		if (document.tax.revaction1.checked == true || document.tax.revaction2.checked == true || document.tax.revaction3.checked == true || document.tax.revaction4.checked == true || document.tax.revaction5.checked == true )
...
{
		if (document.tax.irsnotice1.checked == true || document.tax.irsnotice2.checked == true || document.tax.irsnotice3.checked == true  )
...
{
		if (document.tax.irsnotice1B.checked == true || document.tax.irsnotice2B.checked == true || document.tax.irsnotice3B.checked == true  )
...
function ShowNine()
{
if (document.tax.q1totalirsliability.value =="0" || document.tax.q1totalirsliability.value =="0.0")
...
var q1incomeamount1 = form.q1incomeamount1.value;
var q1incomeamount2 = form.q1incomeamount2.value;
var q1incomeamount3 = form.q1incomeamount3.value;
var q1incomeamount4 = form.q1incomeamount4.value;
var q1incomeamount5 = form.q1incomeamount5.value;

var q1employmentamount1 = form.q1employmentamount1.value;
var q1employmentamount2 = form.q1employmentamount2.value;
var q1employmentamount3 = form.q1employmentamount3.value;
var q1employmentamount4 = form.q1employmentamount4.value;
var q1employmentamount5 = form.q1employmentamount5.value;

var q1civilpenaltyamount1 = form.q1civilpenaltyamount1.value;
var q1civilpenaltyamount2 = form.q1civilpenaltyamount2.value;
var q1totalirsliability = form.q1totalirsliability.value;
var q1totalirsliabilitydup = form.q1totalirsliabilitydup.value;

// question 2
var q2totalirsliability = form.q2totalirsliability.value;

var totalassesedliability1plus2 = form.totalassesedliability1plus2.value;

// question 2
var q2incomeamount1 = form.q2incomeamount1.value;
var q2incomeamount2 = form.q2incomeamount2.value;

var q2employmentamount1 = form.q2employmentamount1.value;
var q2employmentamount2 = form.q2employmentamount2.value;
//var q2employmentamount3 = form.q2employmentamount3.value;
//var q2employmentamount4 = form.q2employmentamount4.value;
//var q2employmentamount5 = form.q2employmentamount5.value;

if (form.q1incomeamount1.value =="") {form.q1incomeamount1.value="0.0";}
if (form.q1incomeamount2.value =="") {form.q1incomeamount2.value="0.0";}

if (form.q1employmentamount1.value =="") {form.q1employmentamount1.value="0.0";}
if (form.q1employmentamount2.value =="") {form.q1employmentamount2.value="0.0";}
if (form.q1civilpenaltyamount1.value =="") {form.q1civilpenaltyamount1.value="0.0";}
if (form.q1civilpenaltyamount2.value =="") {form.q1civilpenaltyamount2.value="0.0";}

// question2
if (form.q2incomeamount1.value =="") {form.q2incomeamount1.value="0.0";}
if (form.q2incomeamount2.value =="") {form.q2incomeamount2.value="0.0";}
if (form.q2employmentamount1.value =="") {form.q2employmentamount1.value="0.0";}
if (form.q2employmentamount2.value =="") {form.q2employmentamount2.value="0.0";}

form.q1totalirsliability.value = ( 
  parseFloat(form.q1incomeamount1.value.replace(",",""))
+ parseFloat(form.q1incomeamount2.value.replace(",",""))
+ parseFloat(form.q1incomeamount3.value.replace(",",""))
+ parseFloat(form.q1incomeamount4.value.replace(",",""))
+ parseFloat(form.q1incomeamount5.value.replace(",",""))
+ parseFloat(form.q1employmentamount1.value.replace(",",""))
+ parseFloat(form.q1employmentamount2.value.replace(",",""))
+ parseFloat(form.q1employmentamount3.value.replace(",",""))
+ parseFloat(form.q1employmentamount4.value.replace(",",""))
+ parseFloat(form.q1employmentamount5.value.replace(",",""))
+ parseFloat(form.q1civilpenaltyamount1.value.replace(",",""))
+ parseFloat(form.q1civilpenaltyamount2.value.replace(",",""))
);

form.q2totalirsliability.value = ( parseFloat(form.q2incomeamount1.value.replace(",",""))
+ parseFloat(form.q2incomeamount2.value.replace(",",""))
+ parseFloat(form.q2employmentamount1.value.replace(",",""))
+ parseFloat(form.q2employmentamount2.value.replace(",",""))
);

form.totalassesedliability1plus2.value = ( parseFloat(form.q1totalirsliability.value) + parseFloat(form.q2totalirsliability.value) );

form.q1totalirsliabilitydup.value = ( parseFloat(form.q1totalirsliability.value));

// + parseFloat(form.incomeamount2.value) + parseFloat(form.employmentamount1.value) + parseFloat(form.employmentamount2.value)
...
<div id="styleswitch">
<span onclick="changeStyle('iphone')" class="iphonecss">Switch to Mobile Phone compatible mode</span><span onclick="changeStyle('normal')" class="desktopcss">Switch To Desktop Mode</span>
</div>
...
<option value="WY">Wyoming
          ...
          <input type="text"  id="zip" class="smallfont">
</td>
      </tr>
      <tr>
        <td nowrap>Telephone Number</td>
        <td nowrap>(<input type="text" size="3" id="areacode" class="smallfont">)<input type="text" size="3" id="prefix" class="smallfont">-<input type="text" size="4" id="phone" class="smallfont"></td>
      </tr>
      <tr>
	...
	<div class="navbox"><a href="#" onClick="hide('q0');show('q1');">Next</a></div>
</div>
<!-- q0 -->
...
<p class="question"><span class="qnumber">1</span> What Type and amount of IRS taxes do you owe? (Assessed)</p>
	...
	<div class="answers">
		<input type="radio" name="incometaxowe" onclick="show('incometax');show('incometaxjoint');" >Yes |
		<input type="radio" name="incometaxowe" onclick="hide('incometax');hide('incometaxjoint');">No</div>


  	<div id="incometax" style="display:none;">
		 <p>Year Amount<br/>
		  1. <select  id="q1incomeyear1" name="q1incomeyear1" onFocus="populateYearSelect(id);"   class="datedrop"/></select>
		  $ <input type="text" name="q1incomeamount1"   value="0.0"  size="8"   onblur="calculate(this.form);checkNumeric(this);" /><br>
		  2. <select name="q1incomeyear2"  id="q1incomeyear2" onFocus="populateYearSelect(id);" class="datedrop"/></select>
		  $ <input type="text" name="q1incomeamount2" value="0.0"   size="8" onblur="calculate(this.form);checkNumeric(this);" /><br>
		  3. <select  id="q1incomeyear3" name="q1incomeyear3" onFocus="populateYearSelect(id);"   class="datedrop"/></select>
		  $ <input type="text" name="q1incomeamount3"   value="0.0"  size="8"   onblur="calculate(this.form);checkNumeric(this);" /><br>
		  4. <select name="q1incomeyear4"  id="q1incomeyear4" onFocus="populateYearSelect(id);" class="datedrop"/></select>
		  $ <input type="text" name="q1incomeamount4" value="0.0"   size="8" onblur="calculate(this.form);checkNumeric(this);" /><br>
		  5. <select  id="q1incomeyear5" name="q1incomeyear5" onFocus="populateYearSelect(id);"   class="datedrop"/></select>
		  $ <input type="text" name="q1incomeamount5"   value="0.0"  size="8"   onblur="calculate(this.form);checkNumeric(this);" />
	...
	<div id="incometaxjoint" class="subquestion" style="display:none;">Concerning this income tax liability, was a joint return filed for any of the years listed?
		<p class="choices subanswer">
			<input type="radio" name="incometaxQ9" onclick="show('incometaxq9ayes');">Yes
			<input type="radio" name="incometaxQ9"  onclick="hide('incometaxq9ayes');">No </p>
		...
		<div id="incometaxq9ayes" style="DISPLAY: none">Was there an understatement of tax on the return(s) attributable to an erroneous item of just one spouse?
			<p class="choices subanswer">
			<input type="radio" name="incometaxQ9a" onclick="show('incometaxq9byes');">Yes
			<input type="radio" name="incometaxQ9a"  onclick="hide('incometaxq9byes');">No </p>

			<div id="incometaxq9byes" style="DISPLAY: none">Did the other spouse know, or have reason to know of the understatement?
			<p class="choices subanswer">
			<input type="radio" name="incometaxQ9b">Yes
			<input type="radio" name="incometaxQ9b">No </p>
			</div>
	...
	<div class="answers">
		<input type="radio" name="employmenttaxowe" onclick="show('employmenttax');" >Yes |
		<input type="radio" name="employmenttaxowe" onclick="hide('employmenttax')">No
	</div>
	...
	<div class="answers">
		<input type="radio" name="civilpenaltyowe" onclick="show('civilpenalty');" >Yes |
		<input type="radio" name="civilpenaltyowe" onclick="hide('civilpenalty')">No </div>

  	<div id="civilpenalty" style="display:none;">
   	 <p>Year Amount<br/>
      1.<select name="q1civilpenaltyyear1" id="q1civilpenaltyyear1" value=""   onFocus="populateYearSelect(id);" class="datedrop"/></select> $<input type="text" name="q1civilpenaltyamount1" value="0.0"  size="8"  onblur="calculate(this.form);checkNumeric(this);"/>
      <br>
      2.<select name="q1civilpenaltyyear2" id="q1civilpenaltyyear2" value=""   onFocus="populateYearSelect(id);" class="datedrop"/></select> $<input type="text" name="q1civilpenaltyamount2" value="0.0"  size="8"  onblur="calculate(this.form);checkNumeric(this);"/>
    </p>
	</div>
...
<!-- End Question Box -->
 ...
 <div class="progressbar"><div class="percent" style="width:16.66%;"></div>Step 2/11</div>
			...
			<p class="choices">
			<input type="radio" name="question2" onClick="hide('question2no');show('question2yes');">Yes
        	<input type="radio" name="question2"  onClick="hide('question2yes');show('question2no');return true;" class="choices">No</p>
  ...
  <div id="question2yes" style="DISPLAY: none">
	<div class="item">Income Tax</div>
	<div class="answers">
		<input type="radio" name="showquestion2incometax" onclick="show('question2incometax');" >Yes |
		<input type="radio" name="showquestion2incometax" onclick="hide('question2incometax');" >No </div>
  ...
  <div id="question2incometax" style="display:none;">
    <p>Year Amount<br/>
	  ...
	  $ <input type="text" name="q2incomeamount2" id="q2incomeamount2" value="0.0"  size="8"   onblur="calculate(this.form);checkNumeric(this);"/>
    </p>
	...
	<div class="item">Employment Tax</div>
	<div class="answers">
		<input type="radio" name="showquestion2employmenttax" onclick="show('question2employmenttax');" >Yes |
		<input type="radio" name="showquestion2employmenttax" onclick="hide('question2employmenttax');" >No </div>


	<div id="question2employmenttax" style="display:none;">
	<p>Year Amount<br/>
	1. <select name="q2employmentyear1" value=""  id="q2employmentyear1" onFocus="populateYearSelect(id);" class="datedrop"></select>
	$ <input type="text" name="q2employmentamount1" id="q2employmentamount1" value="0.0"  size="8" onblur="calculate(this.form);checkNumeric(this);"><br/>
	2. <select name="q2employmentyear2" value=""  id="q2employmentyear2" onFocus="populateYearSelect(id);" class="datedrop"></select>
	$ <input type="text" name="q2employmentamount2" name="q2employmentamount2" value="0.0"  size="8"  onblur="calculate(this.form);checkNumeric(this);">
</p>
</div>
...
<div class="progressbar"><div class="percent" style="width:25%;"></div>Step 3/11</div>
 <p class="question"><span class="qnumber">3</span> Are you current with this year’s withholding and/or estimated payment requirements?</p>
       <p class="choices"> <input type="radio" name="question3" onclick="hide('question3no');show('question3yes');">Yes
        <input type="radio" name="question3"  onclick="hide('question3yes');show('question3no');return true;">No </p>
...
<div class="progressbar"><div class="percent" style="width:33.33%;"></div>Step 4/11</div>
	...
	<p class="choices"> <input type="radio" name="question4" onclick="hide('question4no');show('question4yes');">Yes
        <input type="radio" name="question4"  onclick="hide('question4yes');show('question4no');return true;">No </p>
	...
	<div id="question4yes" style="display:none;">
		...
		<div class="subquestion">How much is being (or will be) levied per paycheck?<br/>&nbsp; <strong>$</strong><input type="text" size="8" name="levied" value="0.0"></div>
		...
		<p class="choices subanswer"> <input type="radio" name="question4hardship" onclick="hide('hardshipno');show('hardshipyes');">Yes
        <input type="radio" name="question4hardship"  onclick="hide('hardshipyes');show('hardshipno');return true;">No </p>
	...
	<div name="banklevied?"> <!-- bank levied -->
		...
		<p class="choices subanswer">
		<input type="radio" name="question4banklevy" onclick="hide('banklevyno');show('banklevyyes');">Yes
        <input type="radio" name="question4banklevy"  onclick="hide('banklevyyes');show('banklevyno');return true;">No </p>
		...
		<div id="banklevyyes" style="display:none;" class="subquestion"> <!-- start bank levy yes -->
			...
			<div>Was the levy issued to the bank within the past 21 days?<br/> <!-- start 21days -->
				<p class="choices subanswer">
				<input type="radio" name="question4banklevy21" onclick="hide('banklevy21no');show('banklevy21yes');">Yes
				<input type="radio" name="question4banklevy21"  onclick="hide('banklevy21yes');show('banklevy21no');return true;">No </p>
				...
				<div id="banklevy21yes" style="display:none;">
					<div>Is the bank levy causing economic hardship which is not enabling you to pay for necessities such as rent, mortgage, groceries, etc.?
						<p class="choices subanswer">
						<input type="radio" name="question4banklevyhardship" onclick="hide('banklevyhardshipno');show('banklevyhardshipyes');">Yes
						<input type="radio" name="question4banklevyhardship"  onclick="hide('banklevyhardshipyes');show('banklevyhardshipno');return true;">No </p>
					</div>
...
<div class="progressbar"><div class="percent" style="width:40%;"></div>Step 5/11</div>
	<p class="question"><span class="qnumber">5</span>Have you been contacted by, or presently dealing with, a Revenue Officer?</p>
		<p class="choices">
		<input type="radio" name="question5" onclick="hide('question5no');show('question5yes');">Yes
        <input type="radio" name="question5" onclick="hide('question5yes');show('question5no');return true;">No
		</p>
				...
				<p>Has the Revenue Officer taken or proposed any of the following collection actions? Select all that apply:<br/>
					...
					<div id="revproposed" style="display:none;">
						<p>Have you met with the Revenue Officer’s Manager (Group Manager) within the last 2 days concerning the collection action(s)?<br/>
							<input type="radio" name="metwithrev" onclick="hide('metwithrevno');show('metwithrevyes');show('associated');">Yes
							<input type="radio" name="metwithrev" onclick="hide('metwithrevyes');show('metwithrevno');hide('associated');;return true;">No </p>
					...
					<div id="metwithrevyes"  class="subquestion" style="display:none;">
						Did the Group Manager sustain the Revenue Officer’s collection action(s)?
							<p class="choices">
								<input type="radio" name="sustain" onclick="hide('sustainno');show('sustainyes');">Yes
								<input type="radio" name="sustain" onclick="hide('sustainyes');show('sustainno');return true;">No
							</p>
							...
							<div id="associated" style="display:none;">Are you, or were you associated (in a financial or decision making capacity) with a company that has unpaid federal employment taxes?
								<p class="choices">
								<input type="radio" name="assoc" onclick="hide('assocno');show('assocyes');">Yes
								<input type="radio" name="assoc" onclick="hide('assocyes');show('assocno');return true;">No
								</p>
									...
									<div id="assocyes" style="display:none;">Is a Revenue Officer attempting to assess the Trust Fund Recovery Penalty against you for unpaid employee withholding taxes for the company you are or were associated with?
											<p class="choices">
											<input type="radio" name="assess" onclick="hide('assessno');show('assessyes');">Yes
											<input type="radio" name="assess" onclick="hide('assessyes');show('assessno');return true;">No
											</p>
	...
	<div class="progressbar"><div class="percent" style="width:64%;"></div>Step 8/11</div>
		<p class="question"><span class="qnumber">8</span>Have you received an IRS notice(s) with the specific heading “Notice of Federal Tax Lien Filing and Your Right to a Hearing under IRC 6320” and the “You must request your hearing by” date has not yet lapsed?</p>
			...
			<div id="irs6320yes" class="subquestion" style="display:none;">
				...
				<input onclick="ds_sh(this);" size="9" name="6320A" style="cursor: text" /> | <input onclick="ds_sh(this);" name="6320B" style="cursor: text" size="9"/> | <input onclick="ds_sh(this);" name="6320C" style="cursor: text" size="9"/>
				</p>
			</div>
			...
			<div id="9aansweryes" class="subquestion" style="display:none;">
				<div class="subquestion">Is this doubt as to liability the result of either an assessment the IRS made because of an audit or because the IRS created a return for you because you did not file a return?<br/>
					...
					<input type="radio" name="q9banswer" value="no" onclick="show('9banswerbox');return true;">No
						...
						<div id="9banswerbox" style="display:none;">Please Explain:<br><textarea class="textbox" name="9bexplanation" id="9bexplanation"></textarea></div>
				</div>
			</div>
		</div>
...
<div id="q10"  style="display:none;" class="questionbox">
	...
	<p class="question"><span class="qnumber">10</span>If you agree that some or all of the unpaid liability is correct and you have the ability to partially pay it, do you feel there are exceptional circumstances that the IRS should consider to compromise this liability for less than you can actually pay? (Examples of exceptional circumstances would be health, disability, age, inability to meet basic living expenses, inability to borrow, collection would cause severe economic hardship, etc.)</p>
					...
					<input type="radio" name="q10banswer" value="no" onclick="hide('10answerbox');return true;">No
						...
						<div id="10answerbox" style="display:none;">Please Explain:<br><textarea class="textbox" name="10explanation" id="10explanation"></textarea></div>
...
<div id="q11"  style="display:none;" class="questionbox">
	...
	<p class="question"><span class="qnumber">11</span>If you agree that some or all of the unpaid liability is correct and you have the ability to full pay it, do you feel there are exceptional circumstances that the IRS should consider to compromise this liability? (Examples of exceptional circumstances would be health, disability, age, inability to meet basic living expenses, inability to borrow, collection would cause severe economic hardship, etc.)</p>
					...
					<input type="radio" name="q11banswer" value="no" onclick="hide('11answerbox');return true;">No
						...
						<div id="11answerbox" style="display:none;">Please Explain:<br><textarea class="textbox" name="11explanation" id="11explanation"></textarea></div>
	<div class="navbox"><a href="#" onClick="hide('q11');show('q10');">Previous</a> | <a href="#" onClick="hide('q11');show('summary');" class="go">Summary</a></div>
</div>
<!-- end question 11 -->


<div id="summary"  style="display:none;" class="questionbox">
	<div class="progressbar"><div class="percent" style="width:100%;"></div>Summary</div>
	<div id="showsummary">Summary To Appear Here (or something...)</div>
	<div class="navbox"><a href="#" onClick="hide('summary');show('q0');" class="review">Click Here To Review All Answers</a>  - Or - <a href="#" onClick="hide('summary');show('send');" class="go">Submit</a></div>
</div>
