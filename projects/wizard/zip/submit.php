...
$summary = "<html><body><div class=\"emailformat\"><style type=\"text/css\">body {color:#ff0000;font-family:arial;}b{color:#999999;};</style> (Testing Note: This display is for demo purposes only. Below is how the email sent to client will appear)";
