...
window.$popcss += "background-image:url('https://dl.dropboxusercontent.com/u/508866/webcode/popup4wire/light.png');";
...
window.$popcss += "background:url('https://dl.dropboxusercontent.com/u/508866/webcode/popup4wire/closebox.png') no-repeat right;";
...
// pophtml content
window.$pophtml = "<h2>Custom PopUp Script © 2014 - E.K.Holbrook</h2>";
...
// if cookie doesn't exist, do this	
	...
	if ($j.cookie("light3") == null) {
			...
			$j.cookie("light3", 1, {expires: cookdate, path:'/'});
